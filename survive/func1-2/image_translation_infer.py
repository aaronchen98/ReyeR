...
# tf.flags.DEFINE_string("model_path", "/root/CSC4001/styleGAN", "Path containing a checkpoint.")
...
if __name__ == '__main__':
  input_image_path = '/root/CSC4001/img'
  num_output = None  
  output_image_path = '/root/CSC4001/style_output_image'
  model_path = "/root/CSC4001/256"
  image_hw = 256
  input_tensor_name = 'sources_ph' 
  output_tensor_name = 'custom_generated_t_style_source:0'  

  # tf.flags.DEFINE_string('input_image_path', '/root/CSC4001/img',
  ...
  # tf.flags.DEFINE_string('output_image_path', '/root/CSC4001/style_output_image',
